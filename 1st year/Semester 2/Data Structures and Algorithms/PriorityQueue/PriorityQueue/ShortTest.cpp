...
void Test_priorityOf()
{
    PriorityQueue priorityQueue(rel);

    priorityQueue.push(10, 10);
    priorityQueue.push(10, 11);
    priorityQueue.push(2, 2);
    priorityQueue.push(2, 4);
    priorityQueue.push(3, 3);

    assert(priorityQueue.priorityOf(10) == 10);
    assert(priorityQueue.priorityOf(2) == 2);
    assert(priorityQueue.priorityOf(3) == 3);

    assert(priorityQueue.priorityOf(111) == -1);
}
