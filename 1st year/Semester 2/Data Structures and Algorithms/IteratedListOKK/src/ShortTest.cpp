...
void testAll() {
    ...
    IteratedList list_test_remove_all = IteratedList();
    list_test_remove_all.addToBeginning(13);
    list_test_remove_all.addToBeginning(14);
    list_test_remove_all.addToBeginning(15);
    list_test_remove_all.addToEnd(16);
    list_test_remove_all.addToEnd(17);

    assert(list_test_remove_all.size() == 5);
    assert(list_test_remove_all.removeAll(list_test_remove_all) == 5);
    assert(list_test_remove_all.isEmpty() == true);
}
