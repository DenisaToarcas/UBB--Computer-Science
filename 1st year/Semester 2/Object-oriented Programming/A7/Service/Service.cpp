...
Service::Service(Repository *repository, userRepo *userRepository, std::string& fileName, Validator* validator, std::string& type_of_file, std::string& filenameUSER) {
...
void Service::writeTutorialsToFile() {
    this->repository->writeTutorialsToFile(this->fileName);
}
