...
public class PrgStatesSelectionController implements Initializable {
    ...
    public void checkIfPrgStateSelected()
    {
        ...
        try{
            ...
            PrgState prgState = new PrgState(exeStack, SymTbl, Out, FileTable, Heap, procTable, stmtToExecute);
    ...
    public void populatePrgStateListView()
    {
        ...
        prgStatesObservableList.add("25. "+exProc.toString());
        prgStates.add(exProc);
