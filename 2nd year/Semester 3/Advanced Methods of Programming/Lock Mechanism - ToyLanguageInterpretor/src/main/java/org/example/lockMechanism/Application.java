...
public class Application extends javafx.application.Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Application.class.getResource("PrgStatesSelectionlock.fxml"));
        ...
        FXMLLoader fxmlLoader1 = new FXMLLoader(Application.class.getResource("PrgStatesExecutionlock.fxml"));
