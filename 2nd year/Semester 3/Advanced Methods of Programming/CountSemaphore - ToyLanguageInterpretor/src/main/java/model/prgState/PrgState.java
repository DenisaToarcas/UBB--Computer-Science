...
public class PrgState{
    ...
    private final MyISemaphore toySemaphore;
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String,Value> symtbl, MyIList<Value>
            ot, MyIFileTable<String, BufferedReader> fileTable, MyIHeap<Integer, Value> heap, MyISemaphore toySemaphore, IStmt prg){
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        this.fileTable = fileTable;
        this.heap = heap;
        this.toySemaphore = toySemaphore;
