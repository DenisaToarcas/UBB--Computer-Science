...
public class MySemaphore implements MyISemaphore{
    ...
    @Override
    public synchronized void add(int key, Tuple<Integer, List<Integer>, Integer> value) throws MyException {
    ...
    @Override
    public synchronized Tuple<Integer, List<Integer>, Integer> getValue(int key) throws MyException {
        if (this.toySemaphoreTable.containsKey(key))
    ...
    @Override
    public synchronized void update(int key, Tuple<Integer, List<Integer>, Integer> value) throws MyException {
        if (this.toySemaphoreTable.containsKey(key))
    ...
    @Override
    public synchronized HashMap<Integer, Tuple<Integer, List<Integer>, Integer>> getToySemaphore() {
        return this.toySemaphoreTable;
    }

    @Override
    public synchronized void setToySemaphore(HashMap<Integer, Tuple<Integer, List<Integer>, Integer>> newToySemaphore) {
