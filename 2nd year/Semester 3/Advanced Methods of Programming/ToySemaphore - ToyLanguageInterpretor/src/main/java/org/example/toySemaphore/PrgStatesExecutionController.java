...
public class PrgStatesExecutionController implements Initializable {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, Integer> ValueColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, Integer> IndexColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, List<Integer>> ListValuesColumn;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        {
            return new SimpleIntegerProperty(p.getValue().getValue().getFirst() - p.getValue().getValue().getThird()).asObject();
        });
        ...
        IStmt exSem = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("cnt", new IntType()),
                        new CompStmt(new aHStmt("v1", new ValueExp(new IntValue(2))),
                                new CompStmt(new newSemaphore("cnt", new rHExp(new VarExp("v1")), new ValueExp(new IntValue(1))),
